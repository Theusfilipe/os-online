...
export default function CriarOrdemServicoModal() {
  ...
  return (
    <div className="modal fade" id="criarOrdemModal" tabIndex={-1} aria-hidden="true">
      <div className="modal-dialog modal-xl modal-dialog-scrollable">
        <div className="modal-content">
          <div className="modal-header">
            <h5 className="modal-title">Criar Ordem de Serviço</h5>
